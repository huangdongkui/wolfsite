...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/act/task/myApply/?pageNo='+n+'&pageSize='+s;
        }
	</script>
</head>
<body>
	<form:form id="searchForm" modelAttribute="act" action="${ctx}/act/task/myApply/" method="get" class="breadcrumb form-search">
		<div>
			<label>流程类型：&nbsp;</label>
