...
<head>
	...
	<%--<link rel="stylesheet" href="${ctxStatic}/BeginnerAdmin/plugins/layui/css/modules/layer/default/layer.css" media="all">--%>
	<%--<script src="${ctxStatic}/BeginnerAdmin/plugins/layui/lay/modules/layer.js"></script>--%>
		...
		$(document).ready(function() {
			<%--$("#btnAdd").click(function () {--%>
               <%--var layerIndex = layer.open({--%>
                    ...
                    <%--area : [ '800px', '520px' ],--%>
                    <%--content : '${ctx}/oa/oaNotify/form'// iframe的url--%>
...
<body>
	...
	<form:form id="searchForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/${oaNotify.self?'self':''}" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li>
			<a href="${ctx}/oa/oaNotify/form"  class="btn btn-primary" id="btnAdd" >添加</a>
			</li></shiro:hasPermission></c:if>
