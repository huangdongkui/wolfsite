...
<%-- 	<c:if test="${menu.parent.id eq (not empty param.parentId ? param.parentId:1)&&menu.isShow eq '1'}"> --%>
		...
		<div class="accordion-group">
		    <div class="accordion-heading">
		    	<a onclick="rootclick(this)" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#menu-${param.parentId}" data-href="#collapse-${menu.id}" href="#collapse-${menu.id}" title="${menu.remarks}">
		    	<i class="icon-chevron-right"></i>&nbsp;${menu.name}</a>
		    </div>
		    <div id="collapse-${menu.id}" class="accordion-body collapse" style="height: 0px;">
