...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic}/jerichotab/js/jquery.jerichotab.js"></script></c:if>
	 <script type="text/javascript" src="${ctxStatic}/modules/sys/sysIndex.js"></script>
	<style type="text/css">
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;display: none;">
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				<div id="left">
					<!--<iframe id="menuFrame" name="menuFrame" src="/wolfsite/a/sys/menu/tree" style="overflow:visible;" scrolling="yes" frameborder="no" width="100%" height="650"></iframe> -->
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2017-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://wolfsite.com" target="_blank">wolfsite</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
