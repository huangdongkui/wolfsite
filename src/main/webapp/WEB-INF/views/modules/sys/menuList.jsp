...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="sys:menu:edit">
        <li><a href="${ctx}/sys/menu/form?isButton=1">按钮添加</a></li>
    </shiro:hasPermission>
</ul>
            ...
            <tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
                ...
                <shiro:hasPermission name="sys:menu:edit">
                    <td nowrap>
                        ...
                        <a href="${ctx}/sys/menu/form?id=${menu.id}&isButton=${menu.isButton}">修改</a>

                        <a href="${ctx}/sys/menu/delete?id=${menu.id}"
                           onclick="return confirmx('要删除该菜单及所有子菜单项吗？', this.href)">删除</a>

                        <c:if test="${menu.isButton eq '0'}">
                            <a href="${ctx}/sys/menu/form?parent.id=${menu.id}">添加下级菜单</a>
                            <a href="${ctx}/sys/menu/form?parent.id=${menu.id}&isButton=1">添加按钮</a>
                        </c:if>
                    </td>
                </shiro:hasPermission>
            </tr>
