 ...
 */
package com.fanhua.wolfsite.modules.act.utils;
...
import com.fanhua.wolfsite.common.annotation.FieldName;
import com.fanhua.wolfsite.common.config.Global;
import com.fanhua.wolfsite.common.utils.Encodes;
import com.fanhua.wolfsite.common.utils.ObjectUtils;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_ProjectApply = new String[]{"projectApply", "project_info"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
