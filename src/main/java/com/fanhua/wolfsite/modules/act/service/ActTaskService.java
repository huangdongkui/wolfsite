 ...
 */
package com.fanhua.wolfsite.modules.act.service;
...
import com.fanhua.wolfsite.common.service.BaseService;
import com.fanhua.wolfsite.common.utils.StringUtils;
import com.fanhua.wolfsite.modules.act.dao.ActDao;
import com.fanhua.wolfsite.modules.act.entity.Act;
import com.fanhua.wolfsite.modules.act.service.cmd.CreateAndTakeTransitionCmd;
import com.fanhua.wolfsite.modules.act.service.cmd.JumpTaskCmd;
import com.fanhua.wolfsite.modules.act.service.creator.ChainedActivitiesCreator;
import com.fanhua.wolfsite.modules.act.service.creator.MultiInstanceActivityCreator;
import com.fanhua.wolfsite.modules.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import com.fanhua.wolfsite.modules.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
import com.fanhua.wolfsite.modules.act.utils.ActUtils;
import com.fanhua.wolfsite.modules.act.utils.ProcessDefCache;
import com.fanhua.wolfsite.modules.act.utils.ProcessDefUtils;
...
public class ActTaskService extends BaseService {
	 ...
	 * @return
	 */
	public Page<Act> myApplyList(Page<Act> page, Act act) {
		...
		//
		// 查询列表
		List<HistoricProcessInstance> histList = taskQuery.listPage(page.getFirstResult(), page.getMaxResults());
		// 处理分页问题
		List<Act> actList = Lists.newArrayList();
		for (HistoricProcessInstance histTask : histList) {
			Act e = new Act();

			TaskEntity currentTask = getCurrentTask(histTask.getId());
			if (currentTask != null) {
	...
	public Page<Act> historicList(Page<Act> page, Act act) {
		...
		for (HistoricTaskInstance histTask : histList) {
			...
			TaskEntity currentTask = getCurrentTask(histTask.getProcessInstanceId());
			if (currentTask != null) {
				histTask.setLocalizedName(currentTask.getName());
			}
			...
			e.setProcDef(ProcessDefCache.get(histTask.getProcessDefinitionId()));
			// Task currentTaskInfo = getCurrentTaskInfo().singleResult());
	 ...
	 * @return
	 */
	public HistoricProcessInstance getfHistProcIns(String procInsId) {
	...
	public InputStream tracePhoto(String processDefinitionId, String executionId) {
		...
		return processEngine.getProcessEngineConfiguration().getProcessDiagramGenerator().generateDiagram(bpmnModel,
				"png", processEngine.getProcessEngineConfiguration().getActivityFontName(),
