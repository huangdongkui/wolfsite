...
import com.fanhua.wolfsite.modules.sys.service.SystemService;
...
public class MenuController extends BaseController {
    ...
    public String form(Menu menu, Model model) {
        ...
        if (StringUtils.isNotBlank(isButton)&&isButton.equals("1")) {
            menu.setIsShow("0");
            model.addAttribute("sysFuncList",sysFuncService.findList(new SysFunc()));
        }
    ...
    public String save(Menu menu, Model model, RedirectAttributes redirectAttributes) {
        ...
        if ("1".equals(request.getParameter("isButton"))) {
            menu.setIsButton("1");
        }
        else{
            menu.setIsButton("0");
        }
        menu.setPermission(request.getParameter("permission"));
...
//		}
    ...
    @ResponseBody
    @RequestMapping(value = "menuListByParentId")
    public List<Menu> getMenuListByParentId(String parentId) {
        //List<Menu> list = Lists.newArrayList();
        List<Menu> sourcelist = systemService.findMenuByParentID(parentId);
        //Menu.sortList(list, sourcelist, Menu.getRootId(), true);
        // model.addAttribute("list", list);
        return sourcelist;
    }
    ...
    @ResponseBody
    @RequestMapping(value = "listMenuByParentIdWithPermit")
    public List<Menu> listMenuByParentIdWithPermit(String parentId) {
        List<Menu> sourcelist = systemService.findMenuByParentIdWithPermit(parentId);
        return sourcelist;
    }
